...
_Drawing Suggestion:_ _Create a split diagram. On the left, show a collection of scattered, unlabeled dots, and then show them circled into 3-4 distinct color-coded groups. Label it "Clustering: Can we find groups?". On the right, show a shopping cart with bread and an arrow pointing to a bottle of milk. Label it "Association: What things go together?"._
