...
_Drawing Suggestion:_ _Create a cyclical diagram. An arrow goes from an "Agent" (a robot icon) to the "Environment" (a box icon), labeled "Action." Another arrow comes back from the "Environment" to the "Agent," labeled "State & Reward." This shows the continuous feedback loop._
